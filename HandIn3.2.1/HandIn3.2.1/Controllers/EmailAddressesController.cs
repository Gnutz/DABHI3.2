...
namespace HandIn3._2._1.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmailAddressesController : ControllerBase
    {
        private readonly PersonCatalogueContext _context;

        public EmailAddressesController(PersonCatalogueContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostEmailAddress([FromBody] EmailAddress emailAddress)
        {
            ...
            return CreatedAtAction("GetEmailAddress", new { id = emailAddress.EmailId }, emailAddress);
        }
        ...
        {
            return _context.EmailAddress.Any(e => e.EmailId == id);
        }
    }
}